  ...
  return (
    <div>
      ...
      <main className="main-part">
        ...
        <p>On this site there is fun quiz that will just see if you can pick the Shoujo. Nothing more and nothing serious, there is a few things listed on the link page that helped formed the idea or are just good video/non-video essay formed information about anime and manga. Click the button below to head to the quiz page and see if you know the Shoujo.</p>
